...
class Estimator:
    ...
    def postprocess(model_output):
        ...
        for c, s, bbox in zip(all_classes, all_scores, all_bboxes):
            bbox[0], bbox[1], bbox[2], bbox[3] = bbox[1].tolist(), bbox[0].tolist(), bbox[3].tolist(), bbox[2].tolist()
    ...
    def predict(self, data, **kwargs):
        ...
        with self.session.as_default():
            ...
            input_feed = self.create_input_feed(self.session, new_image, img_data_np)
